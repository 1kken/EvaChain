CREATE OR REPLACE FUNCTION academic_performance(p_unit_id INTEGER)
RETURNS TABLE (
  office_id INTEGER,
  office_code VARCHAR,
  office_name VARCHAR,
...
GRANT EXECUTE ON FUNCTION academic_performance(INTEGER) TO authenticated;

-- Add comment explaining the function
COMMENT ON FUNCTION academic_performance(INTEGER) IS 
