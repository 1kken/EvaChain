-- Create teaching_effectiveness table
...
CREATE INDEX idx_teaching_effectiveness_ipcr_id ON teaching_effectiveness(ipcr_id);

-- Add updated_at trigger
CREATE TRIGGER set_updated_at
    BEFORE UPDATE ON teaching_effectiveness
    FOR EACH ROW
...
-- Create RLS policies
CREATE POLICY "Users can perform all operations on their own teaching effectiveness"
    ON teaching_effectiveness
    TO authenticated
    USING (ipcr_id IN (
