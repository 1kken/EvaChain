...
CREATE INDEX idx_other_activities_ipcr_id ON other_activities(ipcr_id);

-- Add updated_at trigger
CREATE TRIGGER set_updated_at
    BEFORE UPDATE ON other_activities
    FOR EACH ROW
...
-- Create RLS policies
CREATE POLICY "Users can perform all operations on their own other activities"
    ON other_activities
    TO authenticated
    USING (ipcr_id IN (
