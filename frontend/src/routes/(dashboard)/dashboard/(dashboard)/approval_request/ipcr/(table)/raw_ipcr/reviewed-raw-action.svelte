...
<AlertDialog.Root bind:open={isOpen}>
	<AlertDialog.Trigger class="focus-visible:outline-none">
		<span class="flex items-center gap-3">
			<Star size="16" /> Set Status as Reviewed
		</span>
	</AlertDialog.Trigger>
	<AlertDialog.Content>
		<AlertDialog.Header>
			...
			<AlertDialog.Description>
				This will set the status of the IPCR as <span class="font-bold">Reviewed.</span>
				<br />
				This will allow <span class=" font-bold italic">{ipcr_details.owner_full_name}.</span>
				<br />
				To upload <span class="font-bold"> Accomplishments and Self-Rating </span>
			</AlertDialog.Description>
		</AlertDialog.Header>
		<form method="POST" action="?/reviewedraw" use:enhance>
