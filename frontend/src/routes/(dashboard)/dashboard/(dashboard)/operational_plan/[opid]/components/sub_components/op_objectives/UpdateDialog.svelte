<script lang="ts">
	...
	$formData.activity = opObjective.activity;
	$formData.indicator = opObjective.indicator;
	$formData.former_state = opObjective.former_state;
	$formData.desired_state = opObjective.desired_state;
	$formData.q1 = opObjective.q1;
	$formData.q2 = opObjective.q2;
	$formData.q3 = opObjective.q3;
	$formData.q4 = opObjective.q4;
	$formData.item = opObjective.item;
	$formData.qty = opObjective.qty;
	$formData.unit = opObjective.unit;
	$formData.unit_cost = opObjective.unit_cost;
	$formData.amount = opObjective.amount;
	$formData.fund_source = opObjective.fund_source;
	$formData.entity_responsible = opObjective.entity_responsible;
