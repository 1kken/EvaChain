...
export type Database = {
  ...
  public: {
      ...
      accomplishment_header: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["accomplishment_report_id"]
            isOneToOne: false
            referencedRelation: "accomplishment_report_avg_rate"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "accomplishment_header_accomplishment_report_id_fkey"
      ...
      accomplishment_report: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["office_id"]
            isOneToOne: false
            referencedRelation: "office_performance_history"
            referencedColumns: ["office_id"]
          },
          {
            foreignKeyName: "accomplishment_report_office_id_fkey"
            columns: ["office_id"]
            isOneToOne: false
            referencedRelation: "office_teaching_effectiveness_history"
            referencedColumns: ["office_id"]
          },
          {
            foreignKeyName: "accomplishment_report_office_id_fkey"
      ...
      dpcr_assessor: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["dpcr_id"]
            isOneToOne: false
            referencedRelation: "dpcr_performance_summary"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Views: {
      accomplishment_report_avg_rate: {
        Row: {
          ...
          title: string | null
          total_accomplishment_rate: number | null
          unit_id: number | null
          updated_at: string | null
        }
        Relationships: [
      ...
      dpcr_performance_summary: {
        Row: {
          ...
          review_by: string | null
          reviewer_position: string | null
          status: Database["public"]["Enums"]["dpcr_status"] | null
          title: string | null
          unit_id: number | null
          updated_at: string | null
      ...
      office_performance_history: {
        Row: {
          office_code: string | null
          office_id: number | null
          office_name: string | null
          period_1_avg: number | null
          period_2_avg: number | null
          year: number | null
        }
        Relationships: []
      }
      office_teaching_effectiveness_history: {
        Row: {
          office_code: string | null
          office_id: number | null
          office_name: string | null
    ...
    Functions: {
      academic_accomplishment_performance: {
        Args: {
          p_unit_id: number
        }
        Returns: {
      ...
      get_office_teaching_effectiveness_avg: {
        Args: {
          p_unit_id?: number
        }
        Returns: Json
      }
      get_operational_plans_by_head_or_vp: {
      ...
      get_operational_plans_by_office_for_program_chair: {
        Args: {
          p_office_id: number
        }
        Returns: {
      ...
      get_operational_plans_by_unit_for_dean_or_head: {
        Args: {
          p_unit_id: number
        }
        Returns: {
      ...
      tech_admin_accomplishment_performance: {
        Args: {
          p_unit_id: number
        }
        Returns: {
