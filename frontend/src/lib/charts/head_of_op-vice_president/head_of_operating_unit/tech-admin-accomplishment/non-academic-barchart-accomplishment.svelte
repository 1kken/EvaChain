<script lang="ts">
	...
	const { techAndAdminAccomplishmentPerformance } = getHeadsChartStore();

	let accomplishmentData = $techAndAdminAccomplishmentPerformance || [];
...
<canvas id="tech-admin-accomplishment-rate-chart" bind:this={ctx}></canvas>
